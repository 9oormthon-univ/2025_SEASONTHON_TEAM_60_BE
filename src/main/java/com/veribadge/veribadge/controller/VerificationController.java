...
public class VerificationController {
    ...
    @Operation(summary = "인증절차 확인 api", description = " ")
    @GetMapping("/me")
    public Response<certificatesResponseDto> getMyVerificationStatus(Authentication authentication){

        Long userId = Long.valueOf(authentication.getName());
        certificatesResponseDto dto = verificationService.getVerificationStatus(userId);
